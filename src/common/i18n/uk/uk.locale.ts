...
export default {
  ...
  'Privacy.WhoCanAddByPhone': 'Хто може додати мене за номером телефону?',
  'Privacy.WhoCanAddForwardLink': 'Хто може додати посилання на мій обліковий запис при пересиланні моїх повідомлень?',
  'Privacy.WhoCanInvite': 'Хто може додати мене до групових чатів?',
  'Privacy.WhoCanSeeLastSeen': 'Хто може бачити мій час останнього відвідування?',
